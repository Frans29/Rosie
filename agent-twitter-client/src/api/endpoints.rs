...
impl Endpoints {
    pub fn tweet_detail(tweet_id: &str) -> ApiEndpoint {
        ApiEndpoint {
            url: "https://twitter.com/i/api/graphql/xOhkm2104YFZmOzU9PJHg/TweetDetail".to_string(),
    ...
    pub fn tweet_by_rest_id(tweet_id: &str) -> ApiEndpoint {
        ApiEndpoint {
            url: "https://twitter.com/i/api/graphql/DJS3BdhUh21iZ7B7irJDg/TweetResultByRestId"
                .to_string(),
            variables: Some(HashMap::from([
    ...
    pub fn user_tweets(user_id: &str, count: i32, cursor: Option<&str>) -> ApiEndpoint {
        ...
        ApiEndpoint {
            url: "https://twitter.com/i/api/graphql/V721i3_Hh2FyS75OCDO3Q/UserTweets".to_string(),
    ...
    pub fn user_tweets_and_replies(user_id: &str, count: i32, cursor: Option<&str>) -> ApiEndpoint {
        ...
        ApiEndpoint {
            url: "https://twitter.com/i/api/graphql/E4wA21i2sjVyvpliUffSCw/UserTweetsAndReplies"
                .to_string(),
            variables: Some(variables),
            features: Some(HashMap::from([
                ("rweb_tipjar_consumption_enabled".to_string(), true),
