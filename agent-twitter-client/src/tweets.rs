...
pub async fn fetch_tweets(
    ...
    let (value, _headers) = request_api(
        &client.client,
        "https://twitter.com/i/api/graphql/YNXM2Dwv1PSff6a2JD3Ztw/UserTweets",
        headers,
        Method::GET,
        Some(json!({
            "variables": variables,
...
pub async fn fetch_list_tweets(
    ...
    let (value, _headers) = request_api(
        &client.client,
        "https://twitter.com/i/api/graphql/LFKj1wqHNTsEJwv1P7TzaNA/ListLatestTweetsTimeline",
        headers,
        Method::GET,
        Some(json!({
            "variables": variables,
...
pub async fn create_quote_tweet(
    ...
    let (value, _headers) = request_api(
        &client.client,
        "https://twitter.com/i/api/graphql/a1p9wv1PYKBjWv_I3WzS-A/CreateTweet",
        headers,
        Method::POST,
        Some(json!({
            "variables": variables,
...
pub async fn like_tweet(client: &TwitterClient, tweet_id: &str) -> Result<Value> {
    ...
    let (value, _headers) = request_api(
        &client.client,
        "https://twitter.com/i/api/graphql/lI27N6Otwv1PhnEGyILM7A/FavoriteTweet",
        headers,
        Method::POST,
        Some(json!({
            "variables": {
...
pub async fn retweet(client: &TwitterClient, tweet_id: &str) -> Result<Value> {
    ...
    let (value, _headers) = request_api(
        &client.client,
        "https://twitter.com/i/api/graphql/oJPdsZsimlJrUGLR1sjUtA/CreateRetweet",
        headers,
        Method::POST,
        Some(json!({
            "variables": {
...
pub async fn create_long_tweet(
    ...
    let (value, _headers) = request_api(
        &client.client,
        "https://twitter.com/i/api/graphql/YNXM3DGuE2Sff6a1JD3Ztw/CreateNoteTweet",
        headers,
        Method::POST,
        Some(json!({
            "variables": variables,
...
pub async fn fetch_liked_tweets(
    ...
    let (value, _headers) = request_api(
        &client.client,
        "https://twitter.com/i/api/graphql/Y1kSUg3Czo2Zx1aRqpwDow/Likes",
        headers,
        Method::GET,
        Some(json!({
            "variables": variables,
...
pub async fn create_tweet_request(
    ...
    let (value, _headers) = request_api(
        &client.client,
        "https://twitter.com/i/api/graphql/a1p2RWpkUKBjWv_I3WzS-A/CreateTweet",
        headers,
        Method::POST,
        Some(json!({
            "variables": variables,
